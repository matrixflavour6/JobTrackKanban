...
[Your Name]`
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl max-w-3xl w-full max-h-[90vh] overflow-hidden shadow-2xl flex flex-col border border-ink/10">
        ...
        <div className="px-6 py-4 bg-gradient-to-r from-slate-900 via-indigo-950 to-slate-900 text-white flex items-center justify-between border-b border-slate-800">
          <div className="flex items-center space-x-3">
            <div className="p-2.5 rounded-xl bg-plum/30 text-plum border border-plum/30">
            ...
            <div>
              <div className="flex items-center space-x-2">
                ...
                <span className="px-2 py-0.5 rounded-full text-[10px] font-extrabold bg-plum text-white uppercase tracking-wider">
          ...
          <button
            onClick={onClose}
            className="p-1.5 rounded-lg text-ink-soft/60 hover:text-white hover:bg-slate-800 transition-colors cursor-pointer"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="bg-plum-soft border-b border-plum-soft px-6 py-3.5 flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs">
          <div className="flex items-start space-x-2.5">
            <Sparkles className="w-5 h-5 text-plum shrink-0 mt-0.5" />
            <div>
              <span className="font-bold text-purple-950">
                Want 25+ More Templates & Salary Negotiation Spreadsheet?
              </span>
              <p className="text-plum text-[11px]">
          ...
          <a
            ...
            className="shrink-0 inline-flex items-center justify-center px-4 py-2 rounded-lg bg-plum hover:bg-plum text-white font-bold text-xs shadow-xs transition-colors cursor-pointer"
          >
            Get Full Kit ($8)
        ...
        {/* Navigation Tabs */}
        <div className="px-6 pt-3 border-b border-ink/10 bg-paper-dim flex space-x-2 text-xs font-semibold overflow-x-auto">
          <button
        ...
        {/* Content Body */}
        <div className="flex-1 overflow-y-auto p-6 space-y-4 text-xs text-ink-soft bg-paper-dim/50">
        ...
        {/* Modal Footer */}
        <div className="px-6 py-3 bg-white border-t border-ink/10 flex items-center justify-between text-xs">
