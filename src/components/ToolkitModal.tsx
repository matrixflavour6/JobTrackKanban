...
[Your Name]`
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-ink/60 backdrop-blur-xs flex items-center justify-center sm:p-4">
      <div className="ledger-card bg-white rounded-none sm:rounded-2xl max-w-3xl w-full h-full sm:h-auto sm:max-h-[90vh] overflow-hidden shadow-2xl flex flex-col border-0 sm:border border-ink/10">
